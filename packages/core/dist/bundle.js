(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('graphql')) :
  typeof define === 'function' && define.amd ? define(['react', 'graphql'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.zeiqCore = factory(global.React, global.graphql));
}(this, (function (React, graphql) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  function getApolloContext() {
      var context = cache$1.get(React__default['default'].createContext);
      if (!context) {
          context = React__default['default'].createContext({});
          context.displayName = 'ApolloContext';
          cache$1.set(React__default['default'].createContext, context);
      }
      return context;
  }
