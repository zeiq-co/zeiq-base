(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('graphql'), require('react'), require('graphql/language/visitor'), require('graphql/language/printer')) :
  typeof define === 'function' && define.amd ? define(['exports', 'graphql', 'react', 'graphql/language/visitor', 'graphql/language/printer'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.zeiqCore = {}, global.graphql, null, null, global.printer));
}(this, (function (exports, graphql, React, visitor, printer) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  var _a$6 = Object.setPrototypeOf, setPrototypeOf$3 = _a$6 === void 0 ? function (obj, proto) {
      obj.__proto__ = proto;
      return obj;
  } : _a$6;
  ...
  (function (invariant) {
      invariant.log = wrapConsoleMethod$3("log");
  ...
  function shouldInclude(_a, variables) {
      ...
      return getInclusionDirectives(directives).every(function (_a) {
          ...
          if (ifArgument.value.kind === 'Variable') {
              ...
              process.env.NODE_ENV === "production" ? invariant$3(evaledValue !== void 0, 38) : invariant$3(evaledValue !== void 0, "Invalid variable referenced in @" + directive.name.value + " directive.");
          }
          else {
  ...
  function getInclusionDirectives(directives) {
      ...
      if (directives && directives.length) {
          directives.forEach(function (directive) {
              ...
              process.env.NODE_ENV === "production" ? invariant$3(directiveArguments && directiveArguments.length === 1, 39) : invariant$3(directiveArguments && directiveArguments.length === 1, "Incorrect number of arguments for the @" + directiveName + " directive.");
              var ifArgument = directiveArguments[0];
              process.env.NODE_ENV === "production" ? invariant$3(ifArgument.name && ifArgument.name.value === 'if', 40) : invariant$3(ifArgument.name && ifArgument.name.value === 'if', "Invalid argument for the @" + directiveName + " directive.");
              var ifValue = ifArgument.value;
              process.env.NODE_ENV === "production" ? invariant$3(ifValue &&
                  (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 41) : invariant$3(ifValue &&
  ...
  function getFragmentQueryDocument(document, fragmentName) {
      ...
      document.definitions.forEach(function (definition) {
          if (definition.kind === 'OperationDefinition') {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(42) : new InvariantError$3("Found a " + definition.operation + " operation" + (definition.name ? " named '" + definition.name.value + "'" : '') + ". " +
      ...
      if (typeof actualFragmentName === 'undefined') {
          process.env.NODE_ENV === "production" ? invariant$3(fragments.length === 1, 43) : invariant$3(fragments.length === 1, "Found " + fragments.length + " fragments. `fragmentName` must be provided when there is not exactly 1 fragment.");
  ...
  function getFragmentFromSelection(selection, fragmentMap) {
      switch (selection.kind) {
          ...
          case 'FragmentSpread': {
              ...
              process.env.NODE_ENV === "production" ? invariant$3(fragment, 44) : invariant$3(fragment, "No fragment named " + selection.name.value + ".");
              return fragment;
          }
          default:
              return null;
  ...
  function valueToObjectRepresentation(argObj, name, value, variables) {
      if (isIntValue(value) || isFloatValue(value)) {
          ...
          throw process.env.NODE_ENV === "production" ? new InvariantError$3(53) : new InvariantError$3("The inline argument \"" + name.value + "\" of kind \"" + value.kind + "\"" +
  ...
  function checkDocument(doc) {
      process.env.NODE_ENV === "production" ? invariant$3(doc && doc.kind === 'Document', 45) : invariant$3(doc && doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
      var operations = doc.definitions
          .filter(function (d) { return d.kind !== 'FragmentDefinition'; })
          .map(function (definition) {
          if (definition.kind !== 'OperationDefinition') {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(46) : new InvariantError$3("Schema type definitions not allowed in queries. Found: \"" + definition.kind + "\"");
          }
          return definition;
      });
      process.env.NODE_ENV === "production" ? invariant$3(operations.length <= 1, 47) : invariant$3(operations.length <= 1, "Ambiguous GraphQL document: contains " + operations.length + " operations");
      return doc;
  }
  ...
  function getQueryDefinition(doc) {
      ...
      process.env.NODE_ENV === "production" ? invariant$3(queryDef && queryDef.operation === 'query', 48) : invariant$3(queryDef && queryDef.operation === 'query', 'Must contain a query definition.');
      return queryDef;
  }
  function getFragmentDefinition(doc) {
      process.env.NODE_ENV === "production" ? invariant$3(doc.kind === 'Document', 49) : invariant$3(doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
      process.env.NODE_ENV === "production" ? invariant$3(doc.definitions.length <= 1, 50) : invariant$3(doc.definitions.length <= 1, 'Fragment must have exactly one definition.');
      var fragmentDef = doc.definitions[0];
      process.env.NODE_ENV === "production" ? invariant$3(fragmentDef.kind === 'FragmentDefinition', 51) : invariant$3(fragmentDef.kind === 'FragmentDefinition', 'Must be a fragment definition.');
      return fragmentDef;
  }
  function getMainDefinition(queryDoc) {
      ...
      throw process.env.NODE_ENV === "production" ? new InvariantError$3(52) : new InvariantError$3('Expected a parsed GraphQL query with a query, mutation, subscription, or a fragment.');
  }
      ...
      test: function (directive) {
          ...
          if (willRemove) {
              if (!directive.arguments ||
                  ...
                  process.env.NODE_ENV === "production" || invariant$3.warn('Removing an @connection directive even though it does not have a key. ' +
  ...
  function validateOperation$1(operation) {
      ...
      for (var _i = 0, _a = Object.keys(operation); _i < _a.length; _i++) {
          ...
          if (OPERATION_FIELDS.indexOf(key) < 0) {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(26) : new InvariantError$3("illegal argument: " + key);
          }
      }
      return operation;
  }
  ...
  var ApolloLink$1 = (function () {
      ...
      ApolloLink.concat = function (first, second) {
          ...
          if (isTerminating$1(firstLink)) {
              process.env.NODE_ENV === "production" || invariant$3.warn(new LinkError$1("You are calling concat on a terminating link, which will have no effect", firstLink));
              return firstLink;
          }
      ...
      ApolloLink.prototype.request = function (operation, forward) {
          throw process.env.NODE_ENV === "production" ? new InvariantError$3(21) : new InvariantError$3('request is not implemented');
      };
  ...
  var serializeFetchParameter$1 = function (p, label) {
      ...
      try {
          ...
          var parseError = process.env.NODE_ENV === "production" ? new InvariantError$3(23) : new InvariantError$3("Network request failed. " + label + " is not serializable: " + e.message);
  ...
  var checkFetcher$1 = function (fetcher) {
      if (!fetcher && typeof fetch === 'undefined') {
          throw process.env.NODE_ENV === "production" ? new InvariantError$3(22) : new InvariantError$3("\n\"fetch\" has not been found globally and no fetcher has been configured. To fix this, install a fetch package (like https://www.npmjs.com/package/cross-fetch), instantiate the fetcher, and pass it into your HttpLink constructor. For example:\n\nimport fetch from 'cross-fetch';\nimport { ApolloClient, HttpLink } from '@apollo/client';\nconst client = new ApolloClient({\n  link: new HttpLink({ uri: '/graphql', fetch })\n});\n    ");
      }
  };
  ...
  var _a$5 = Object.prototype, toString = _a$5.toString, hasOwnProperty$2 = _a$5.hasOwnProperty;
  ...
  var Reobserver = (function () {
      ...
      Reobserver.prototype.updatePolling = function () {
          ...
          process.env.NODE_ENV === "production" ? invariant$3(pollInterval, 20) : invariant$3(pollInterval, 'Attempted to start a polling query without a polling interval.');
          ...
          return this.queryManager.fetchQuery(qid, combinedOptions, NetworkStatus.fetchMore).then(function (fetchMoreResult) {
              ...
              if (updateQuery) {
                  if (process.env.NODE_ENV !== "production" &&
                      ...
                      process.env.NODE_ENV === "production" || invariant$3.warn("The updateQuery callback for fetchMore is deprecated, and will be removed\nin the next major version of Apollo Client.\n\nPlease convert updateQuery functions to field policies with appropriate\nread and merge functions, or use/adapt a helper function (such as\nconcatPagination, offsetLimitPagination, or relayStylePagination) from\n@apollo/client/utilities.\n\nThe field policy system handles pagination more effectively than a\nhand-written updateQuery function, and you only need to define the policy\nonce, rather than every time you call fetchMore.");
  ...
  var _a$4 = Array.prototype, forEach = _a$4.forEach, slice = _a$4.slice;
  ...
  var StoreReader = (function () {
      ...
      StoreReader.prototype.execSelectionSetImpl = function (_a) {
          ...
          if (isReference(objectOrReference) &&
              ...
              return {
                  result: {},
                  missing: [missingFromInvariant(process.env.NODE_ENV === "production" ? new InvariantError$3(4) : new InvariantError$3("Dangling reference to missing " + objectOrReference.__ref + " object"), context)],
              };
          }
              ...
              if (isField(selection)) {
                  ...
                  if (fieldValue === void 0) {
                      if (!addTypenameToDocument.added(selection)) {
                          getMissing().push(missingFromInvariant(process.env.NODE_ENV === "production" ? new InvariantError$3(5) : new InvariantError$3("Can't find field '" + selection.name.value + "' on " + (isReference(objectOrReference)
                  ...
                  invariant$3(context.path.pop() === resultName);
              }
              else {
      ...
      StoreReader.prototype.execSubSelectedArrayImpl = function (_a) {
          ...
          function handleMissing(childResult, i) {
              ...
              invariant$3(context.path.pop() === i);
      ...
      if (!field.selectionSet) {
          ...
          workSet_1.forEach(function (value) {
              if (value && typeof value === "object") {
                  process.env.NODE_ENV === "production" ? invariant$3(!isReference(value), 6) : invariant$3(!isReference(value), "Missing selection set for object of type " + getTypenameFromStoreObject(store, value) + " returned for query field " + field.name.value);
  ...
  var StoreWriter = (function () {
      ...
      StoreWriter.prototype.writeToStore = function (_a) {
          ...
          if (!isReference(ref)) {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(7) : new InvariantError$3("Could not identify object " + JSON.stringify(result));
          }
          ...
          workSet.forEach(function (selection) {
              ...
              if (isField(selection)) {
                  ...
                  if (typeof value !== 'undefined') {
                      ...
                      throw process.env.NODE_ENV === "production" ? new InvariantError$3(8) : new InvariantError$3("Missing field '" + resultFieldKey + "' in " + JSON.stringify(result, null, 2).substring(0, 100));
                  }
              }
              else {
                  var fragment = getFragmentFromSelection(selection, context.fragmentMap);
  ...
  function warnAboutDataLoss(existingRef, incomingObj, storeFieldName, store) {
      ...
      process.env.NODE_ENV === "production" || invariant$3.warn("Cache data may be lost when replacing the " + fieldName + " field of a " + parentType + " object.\n\nTo address this problem (which is not a bug in Apollo Client), " + (childTypenames.length
  ...
  var Policies = (function () {
      ...
      Policies.prototype.setRootTypename = function (which, typename) {
          ...
          if (typename !== old) {
              process.env.NODE_ENV === "production" ? invariant$3(!old || old === which, 1) : invariant$3(!old || old === which, "Cannot change root " + which + " __typename more than once");
              if (old)
                  ...
                  if (supertypeSet.has(supertype)) {
                      if (!typenameSupertypeSet.has(supertype)) {
                          if (checkingFuzzySubtypes) {
                              process.env.NODE_ENV === "production" || invariant$3.warn("Inferring subtype " + typename + " of supertype " + supertype);
                          }
  ...
  function makeMergeObjectsFunction(getFieldValue) {
      return function mergeObjects(existing, incoming) {
          if (Array.isArray(existing) || Array.isArray(incoming)) {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(2) : new InvariantError$3("Cannot automatically merge arrays");
          }
      ...
      specifier.forEach(function (s) {
          if (Array.isArray(s)) {
              ...
              if (hasOwn.call(response, responseName)) {
                  ...
                  process.env.NODE_ENV === "production" ? invariant$3(!strict, 3) : invariant$3(!strict, "Missing field '" + responseName + "' while computing key fields");
                  prevKey = void 0;
              }
          }
      });
                  ...
                  execute = function (selection) { return __awaiter(_this, void 0, void 0, function () {
                      ...
                      return __generator(this, function (_a) {
                          ...
                          if (isInlineFragment(selection)) {
                              ...
                              process.env.NODE_ENV === "production" ? invariant$3(fragment, 11) : invariant$3(fragment, "No fragment named " + selection.name.value);
                          }
  ...
  var QueryManager = (function () {
      ...
      QueryManager.prototype.stop = function () {
          ...
          this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new InvariantError$3(12) : new InvariantError$3('QueryManager stopped while query was in flight'));
      };
      ...
      QueryManager.prototype.mutate = function (_a) {
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_f) {
                  switch (_f.label) {
                      case 0:
                          process.env.NODE_ENV === "production" ? invariant$3(mutation, 13) : invariant$3(mutation, 'mutation option is required. You must specify your GraphQL document in the mutation option.');
                          process.env.NODE_ENV === "production" ? invariant$3(!fetchPolicy || fetchPolicy === 'no-cache', 14) : invariant$3(!fetchPolicy || fetchPolicy === 'no-cache', "Mutations only support a 'no-cache' fetchPolicy. If you don't want to disable the cache, remove your fetchPolicy setting to proceed with the default mutation behavior.");
      ...
      QueryManager.prototype.markMutationOptimistic = function (optimisticResponse, mutation) {
          ...
          return this.cache.recordOptimisticTransaction(function (cache) {
              try {
                  ...
                  process.env.NODE_ENV === "production" || invariant$3.error(error);
              }
          }, mutation.mutationId);
      };
      ...
      QueryManager.prototype.query = function (options) {
          var _this = this;
          process.env.NODE_ENV === "production" ? invariant$3(options.query, 15) : invariant$3(options.query, 'query option is required. You must specify your GraphQL document ' +
              'in the query option.');
          process.env.NODE_ENV === "production" ? invariant$3(options.query.kind === 'Document', 16) : invariant$3(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
          process.env.NODE_ENV === "production" ? invariant$3(!options.returnPartialData, 17) : invariant$3(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
          process.env.NODE_ENV === "production" ? invariant$3(!options.pollInterval, 18) : invariant$3(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
      ...
      QueryManager.prototype.clearStore = function () {
          this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new InvariantError$3(19) : new InvariantError$3('Store reset while query was in flight (not completed in link chain)'));
      ...
      QueryManager.prototype.fetchQueryByPolicy = function (queryInfo, options, networkStatus) {
          ...
          var resultsFromCache = function (diff, networkStatus) {
              ...
              if (process.env.NODE_ENV !== 'production' &&
                  ...
                  !equal(data, {}) &&
                  !returnPartialData) {
                  process.env.NODE_ENV === "production" || invariant$3.warn("Missing cache result fields: " + diff.missing.map(function (m) { return m.path.join('.'); }).join(', '), diff.missing);
              }
  ...
  var ApolloClient = (function () {
      function ApolloClient(options) {
          ...
          if (!cache) {
              throw process.env.NODE_ENV === "production" ? new InvariantError$3(9) : new InvariantError$3("To initialize Apollo Client, you must specify a 'cache' property " +
          ...
          if (!hasSuggestedDevtools && process.env.NODE_ENV !== 'production') {
              ...
              if (typeof window !== 'undefined' &&
                  ...
                  if (url) {
                      invariant$3.log("Download the Apollo DevTools for a better development " +
                          "experience: " + url);
                  }
              }
          }
      ...
      ApolloClient.prototype.query = function (options) {
          ...
          process.env.NODE_ENV === "production" ? invariant$3(options.fetchPolicy !== 'cache-and-network', 10) : invariant$3(options.fetchPolicy !== 'cache-and-network', 'The cache-and-network fetchPolicy does not work with client.query, because ' +
  ...
  ***************************************************************************** */
  ...
  function parser(document) {
      ...
      process.env.NODE_ENV === "production" ? invariant$3(!!document && !!document.kind, 34) : invariant$3(!!document && !!document.kind, "Argument of " + document + " passed to parser was not a valid GraphQL " +
      ...
      process.env.NODE_ENV === "production" ? invariant$3(!fragments.length ||
          (queries.length || mutations.length || subscriptions.length), 35) : invariant$3(!fragments.length ||
          (queries.length || mutations.length || subscriptions.length), "Passing only a fragment to 'graphql' is not yet supported. " +
          "You must include a query, subscription or mutation as well");
      process.env.NODE_ENV === "production" ? invariant$3(queries.length + mutations.length + subscriptions.length <= 1, 36) : invariant$3(queries.length + mutations.length + subscriptions.length <= 1, "react-apollo only supports a query, subscription, or a mutation per HOC. " +
      ...
      var definitions = queries.length
          ...
          : mutations.length
              ? mutations
              : subscriptions;
      process.env.NODE_ENV === "production" ? invariant$3(definitions.length === 1, 37) : invariant$3(definitions.length === 1, "react-apollo only supports one definition per HOC. " + document + " had " +
  ...
  var OperationData = (function () {
      ...
      OperationData.prototype.refreshClient = function () {
          ...
          process.env.NODE_ENV === "production" ? invariant$3(!!client, 29) : invariant$3(!!client, 'Could not find "client" in the context or passed in as an option. ' +
      ...
      OperationData.prototype.verifyDocumentType = function (document, type) {
          ...
          process.env.NODE_ENV === "production" ? invariant$3(operation.type === type, 30) : invariant$3(operation.type === type, "Running a " + requiredOperationName + " requires a graphql " +
  ...
  function validateOperation(operation) {
      ...
      for (var _i = 0, _a = Object.keys(operation); _i < _a.length; _i++) {
          var key = _a[_i];
          if (OPERATION_FIELDS.indexOf(key) < 0) {
              throw process.env.NODE_ENV === "production" ? new InvariantError$2(2) : new InvariantError$2("illegal argument: " + key);
          }
      }
      return operation;
  }
  ...
  var ApolloLink = (function () {
      ...
      ApolloLink.prototype.request = function (operation, forward) {
          throw process.env.NODE_ENV === "production" ? new InvariantError$2(1) : new InvariantError$2('request is not implemented');
      };
